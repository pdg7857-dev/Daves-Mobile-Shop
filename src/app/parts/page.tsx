      ...
      <div className="mt-8 flex flex-wrap gap-2">
        <Link
          ...
          className={`text-sm rounded-full px-3 py-1 border ${
            !sp.category ? "bg-brand-700 text-white border-brand-700" : "bg-white text-gray-700 border-gray-300 hover:bg-gray-50"
          }`}
        >
          All categories
        </Link>
        {categories.map((c) => (
          <Link
            ...
            className={`text-sm rounded-full px-3 py-1 border capitalize ${
              sp.category === c.category ? "bg-brand-700 text-white border-brand-700" : "bg-white text-gray-700 border-gray-300 hover:bg-gray-50"
            }`}
          >
            {c.category.replace("-", " ")}
          </Link>
